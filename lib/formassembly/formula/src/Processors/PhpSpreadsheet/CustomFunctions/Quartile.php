...
final class Quartile implements CustomFunction
{
    ...
    {
        $args = func_get_args();
        $quartile = array_pop($args);

        return Percentiles::QUARTILE(ReduceToNumerics::givenValues(Flatten::anArray($args)), $quartile);
    }
}
