...
use PhpOffice\PhpSpreadsheet\Calculation\TextData\Search as PhpSpreadsheetSearch;

final class Search implements CustomFunction
{
    ...
    public static function compute()
    {
        ...
        return PhpSpreadsheetSearch::insensitive(...func_get_args());
    }
}
