...
class DateValue
{
    ...
    private static function setUpArray(string $dateValue, DateTimeImmutable $dti): array
    {
        ...
        if (!Helpers::dateParseSucceeded($PHPDateArray)) {
            ...
            /**
             * START CUSTOMIZATION
             * By default the application tests first the format DD/MM/YYYY
             * Switching to test first MM/DD/YYYY
             * So it's compatible with the old behavior
             */
            Helpers::adjustYear((string) $testVal1, (string) $testVal2, $testVal3);
            if (strlen($testVal1) <= 2) {
